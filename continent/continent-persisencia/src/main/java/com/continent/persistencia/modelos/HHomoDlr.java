...
/**
 * The persistent class for the h_homo_dlr database table.
 * 
 */
@Entity
@Table(name="h_homo_dlr")
@NamedQuery(name="HHomoDlr.findAll", query="SELECT h FROM HHomoDlr h")
public class HHomoDlr implements Serializable {
